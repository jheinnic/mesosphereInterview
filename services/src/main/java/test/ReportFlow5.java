...
//      }
      ...
      // B
      builder
         .addEdge(pickups[0], dropOffs[0], 4)
//         .addEdge(pickups[0], dropOffs[1], 1)
//         .addEdge(pickups[1], dropOffs[0], 1)
         .addEdge(pickups[1], dropOffs[1], 5)
      ;
...
//      System.out.println(Arrays.toString(normScoresA));
      ...
      MatchingAlgorithm<AbstractNode, DefaultWeightedEdge> matchingAlg =
         new HopcroftKarpMaximumCardinalityBipartiteMatching<AbstractNode, DefaultWeightedEdge>(
