...
public class DecisionExplorer {
	...
	public static class Elevator {
		...
		public void arrive() {
			System.out.println(String.format("Arrived at %d", this.port.now()));
		}
...
//			System.out.println(String.format("%d", pulse.now));
	...
	public static void main( String[] args ) {
		...
		ExecutorService fooPool = Executors.newSingleThreadExecutor(foo);
		Scheduler scheduler = Schedulers.from(fooPool);
